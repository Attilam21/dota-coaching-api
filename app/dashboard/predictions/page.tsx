    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <Link
          ...
          className="bg-gradient-to-r from-cyan-900/30 to-blue-900/30 border border-cyan-500/50 rounded-lg p-6 hover:border-cyan-400 transition-all group"
        >
        ...
        <Link
          ...
          className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 border border-purple-500/50 rounded-lg p-6 hover:border-purple-400 transition-all group"
        >
          <div className="flex items-center justify-between mb-3">
