  ...
  if (data.steps.length === 0) {
    return (
      <div className="p-4 md:p-6 space-y-6">
          ...
          <div className={`${styles.hasBackground ? 'bg-gray-800 backdrop-blur-sm' : 'bg-gray-800'} border border-gray-700 rounded-lg p-6`}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              ...
              <div>
                ...
                <div className={`text-2xl font-bold ${styles.textPrimary}`}>{data.currentStats.kda}</div>
              </div>
              <div>
                <div className={`text-sm ${styles.textSecondary} mb-1`}>Morti</div>
                <div className={`text-2xl font-bold ${styles.textPrimary}`}>{data.currentStats.deaths}</div>
              </div>
              <div>
                <div className={`text-sm ${styles.textSecondary} mb-1`}>Ruolo</div>
                <div className={`text-2xl font-bold ${styles.textPrimary} capitalize`}>{data.currentStats.role}</div>
              </div>
            </div>
          </div>
        )}
        ...
        <div className={`${styles.hasBackground ? 'bg-green-900/40 backdrop-blur-sm' : 'bg-gradient-to-r from-green-900/30 to-cyan-900/30'} border border-green-500/50 rounded-xl p-8 text-center`}>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                <span className={styles.textSecondary}>GPM:</span>
                <span className={`${styles.textPrimary} font-bold`}>{data.currentStats.gpm}</span>
              </div>
              <div className="flex justify-between">
                <span className={styles.textSecondary}>KDA:</span>
                <span className={`${styles.textPrimary} font-bold`}>{data.currentStats.kda}</span>
              </div>
              <div className="flex justify-between">
                <span className={styles.textSecondary}>Morti:</span>
                <span className={`${styles.textPrimary} font-bold`}>{data.currentStats.deaths}</span>
              </div>
              <div className="flex justify-between">
                <span className={styles.textSecondary}>Ruolo:</span>
                <span className={`${styles.textPrimary} font-bold capitalize`}>{data.currentStats.role}</span>
              </div>
            </div>
          </div>
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                <span className={styles.textSecondary}>Tempo Stimato:</span>
                <span className="text-blue-400 font-bold">{data.projectedOutcome.estimatedMatches} partite</span>
              </div>
              <div className="flex justify-between">
                <span className={styles.textSecondary}>Timeframe:</span>
              ...
              <div className="flex items-start gap-4 flex-1">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <h3 className={`text-lg font-bold ${styles.textPrimary}`}>Step {idx + 1}: {step.title}</h3>
      ...
      <div className={`${styles.hasBackground ? 'bg-gray-800 backdrop-blur-sm' : 'bg-gray-800'} border border-gray-700 rounded-lg p-6`}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className={`${styles.cardSubtle} p-4`}>
            <div className={`text-sm ${styles.textSecondary} mb-1`}>GPM Gap</div>
          ...
          <div className={`${styles.cardSubtle} p-4`}>
            <div className={`text-sm ${styles.textSecondary} mb-1`}>XPM Gap</div>
          ...
          <div className={`${styles.cardSubtle} p-4`}>
            <div className={`text-sm ${styles.textSecondary} mb-1`}>KDA Gap</div>
          ...
          <div className={`${styles.cardSubtle} p-4`}>
            <div className={`text-sm ${styles.textSecondary} mb-1`}>Deaths Gap</div>
