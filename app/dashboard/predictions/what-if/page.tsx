  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      {data.summary.bestScenario && (
        <div className={`${styles.hasBackground ? 'bg-green-900/40 backdrop-blur-sm' : 'bg-gradient-to-r from-green-900/30 to-cyan-900/30'} border border-green-500/50 rounded-xl p-6 shadow-lg shadow-green-500/20`}>
      ...
      {data.summary.combinedImpact && (
        <div className={`${styles.hasBackground ? 'bg-purple-900/40 backdrop-blur-sm' : 'bg-gradient-to-r from-purple-900/30 to-pink-900/30'} border border-purple-500/50 rounded-xl p-6 shadow-lg shadow-purple-500/20`}>
