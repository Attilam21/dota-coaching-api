          ...
          <div className="bg-gray-800 border border-gray-700 rounded-lg mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-gray-700/50 rounded-lg p-4">
                <h3 className={`text-sm ${styles.textSecondary} mb-2`}>Early Game (0-15min)</h3>
                <p className="text-2xl font-bold text-green-400">{stats.farm.phaseAnalysis.early.winrate}%</p>
                <p className={`text-xs ${styles.textMuted} mt-1`}>{stats.farm.phaseAnalysis.early.matches} partite</p>
                <p className={`text-xs ${styles.textMuted}`}>Durata media: {Math.round(stats.farm.phaseAnalysis.early.avgDuration / 60)}min</p>
              </div>
              <div className="bg-gray-700/50 rounded-lg p-4">
                <h3 className={`text-sm ${styles.textSecondary} mb-2`}>Mid Game (15-30min)</h3>
                <p className="text-2xl font-bold text-blue-400">{stats.farm.phaseAnalysis.mid.winrate}%</p>
                <p className={`text-xs ${styles.textMuted} mt-1`}>{stats.farm.phaseAnalysis.mid.matches} partite</p>
